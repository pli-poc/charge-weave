    ...
    <>
      ...
      <header className="header">
        <div className="container nav-wrap">
          <a className="brand" href="#" aria-label="ChargeWeave home">
            <Mark />
          ...
          <div className="container foundation-layout">
            <div>
              ...
              <a
                ...
                href={`${repository}/blob/main/docs/semantic-design.md`}
                target="_blank"
                rel="noreferrer"
              >
                Explore the semantic model <ArrowUpRight size={17} />
              </a>
            </div>
            <div
          ...
          <div className="container">
            <div className="section-heading">
              ...
              <a
                ...
                rel="noreferrer"
              >
                Follow progress on GitHub <ArrowUpRight size={17} />
              </a>
            </div>
