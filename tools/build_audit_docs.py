...
for r in requirements:
    text += ['', '## ' + r['id'] + ' — ' + r['statement'], '',
             ...
             '- Historical adversarial review: ' + r.get('adversarialFinding','See the current completion review for wider cross-domain evidence.') ,
             '- Completion interaction scenarios: ' + (', '.join(r.get('completionScenarios',[])) or 'Core focused decisions and associated journey snapshots.') ,
