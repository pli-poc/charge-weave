...
for args in [['validate.py','--meta'],['test_business.py'],['test_boundaries.py'],['test_trust_boundary.py'],['check_owl.py'],['check_release.py'],['check_audit.py'],['test_business_acceptance.py'],['test_lifecycle.py'],['check_naming.py']]:
